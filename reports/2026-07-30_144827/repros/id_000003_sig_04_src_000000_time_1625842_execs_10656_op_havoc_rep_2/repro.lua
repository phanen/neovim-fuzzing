...
do  -- extra round 1 (round 8 replayed)
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_buf_delete, 1, {["unload"]=true,["force"]=true})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_buf_delete, 2, {["force"]=true})
end
do  -- extra round 2 (round 8 replayed)
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_buf_delete, 1, {["unload"]=true,["force"]=true})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_buf_delete, 2, {["force"]=true})
end
do  -- extra round 3 (round 8 replayed)
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_buf_delete, 1, {["unload"]=true,["force"]=true})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_buf_delete, 2, {["force"]=true})
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-07-30/default/crashes/id:000003,sig:04,src:000000,time:1625842,execs:10656,op:havoc,rep:2 (820 bytes)
