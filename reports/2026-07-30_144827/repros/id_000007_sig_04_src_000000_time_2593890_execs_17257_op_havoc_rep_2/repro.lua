...
safe(vim.api.nvim_set_option_value, "laststatus", 91270, {})
end
do  -- round 5
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_input, "<Esc><CR>u<Esc><CR>pdpa<Esc>uxpa<CR>i<Esc>xd<Esc>uuxpidup<CR>pi<CR>dx<CR>ax<CR>ai<CR>iu<Esc><CR><CR><Esc>axii<CR>p<CR><CR><Esc>a<Esc>iidpdixdip<CR>dppai<CR><CR>ipxu<CR>xip<CR>ixpdappda<Esc><CR><CR>dpau<Esc>iidd<Esc>upp<CR><Esc>adauua<Esc>dddaidiapuiipp<CR><CR>d<Esc>ixd<CR>diiaa<CR>iupxd<CR>apdu<Esc>ixdd<CR><CR><Esc>d<Esc><Esc>ia<CR><CR>dix<Esc>d<Esc>axu<CR>pdu<Esc>x<CR>aippxaa<CR>daauxpadaa<Esc><CR><CR>dpa<CR>ix<Esc><CR><CR>uiaxa<Esc>daxi<Esc>up<Esc><Esc><Esc>duppai<Esc>a<Esc>axpxxadadaud<Esc>i<Esc>dpi<CR>xa<Esc><CR>iddp<CR><Esc>axa<Esc>uipx<Esc>pxaixp<Esc>dd<CR>aaiaappipxxapda<Esc>u<CR>ixidudip<Esc><CR>p<CR>aiia<CR>ax<CR>x<Esc>dai<Esc>ad<CR>xuiadiua<Esc>duauxdad<Esc><Esc>p<CR><CR>pi<Esc>dipaai<Esc>p<CR><Esc>dudiudppu<Esc><Esc>dxapd<Esc>dxxxd<Esc>uai<CR>duxdp<Esc>au<Esc><Esc><Esc>ip<CR>iipidx<CR>ixidxxxpppaa<CR>paiduuixudxadx<Esc><Esc>dupipi<CR>adipai<Esc>dadpai<CR>d<CR><CR><Esc>dxuudp<CR>p<Esc><CR>daiduix<Esc>iaaxpa<Esc>xa<Esc>xau")
safe(vim.cmd, "redrawstatus")
end
do  -- round 6
safe(vim.api.nvim_list_bufs)
...
do  -- round 7
safe(vim.api.nvim_list_wins)
safe(vim.api.nvim_set_option_value, "statuscolumn", "%c%v", {})
end
do  -- round 8
safe(vim.api.nvim_create_autocmd, "BufRead", {["pattern"]="????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????",["callback"]=_stub_cb})
end
do  -- round 9
safe(vim.api.nvim_set_option_value, "statuscolumn", "%s%l", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_input, "<M-ü‡ƒ‘³ƒ>")
end
do  -- round 10
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim__redraw, {["buf"]=0,["valid"]=true})
safe(vim.cmd, "redrawstatus")
end
do  -- round 11
safe(vim.api.nvim_list_wins)
...
do  -- round 23
safe(vim.api.nvim_set_option_value, "statuscolumn", "%f", {})
end
do  -- round 24
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_exec_autocmds, "CursorMoved", {["pattern"]="*"})
end
do  -- round 25
safe(vim.api.nvim_list_bufs)
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-07-30/default/crashes/id:000007,sig:04,src:000000,time:2593890,execs:17257,op:havoc,rep:2 (853 bytes)
