...
do  -- round 6
safe(vim.api.nvim_set_var, "fz_dkfqds", "YZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~UVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~yz{|}~STUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~wxyz{|}~")
end
do  -- round 7
...
safe(vim.api.nvim_input, "<F2>")
safe(vim.cmd, "redrawstatus")
safe(vim.api.nvim_paste, "\0\2\3\6\21\22\23\24\27\127>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~~", false, -1)
end
do  -- round 12
safe(vim.api.nvim_list_bufs)
...
safe(vim.api.nvim_input, "uu<Esc><CR>apux<CR>ppad<Esc><Esc><Esc>d<Esc>xxiaaidix<Esc>daaiud<CR>paixaxi<CR><Esc>daai<Esc><CR>udp<Esc>dppuiux<Esc>dddpxpi<CR>ipxip<Esc>u<CR><Esc><CR>ipxx<CR>x<CR>ipx<CR>a<Esc>pdd<CR>uxaaixpdppaxu<Esc>paua<Esc>uxuxpiu<Esc>pap<Esc>uxiiu<Esc>uad<Esc>auuxudip<Esc>u<Esc>ixd<Esc>xd<Esc>uuxpidup<CR>pi<CR>dx<CR>ax<CR>ai<CR>iu<Esc><CR><CR><Esc>axii<CR>p<CR><CR><Esc>a<Esc>iidpdixdip<CR>dppai<CR><CR>ipxu<CR>xip<CR>ixpdappdu<Esc>pupiddp<Esc>uuax<CR><Esc>uuda<CR><CR>dia<Esc>iuui<CR>p<Esc><Esc>uaaduia<CR>dai<CR>a<Esc>xxp<Esc>dud<CR>uaxpi<CR>ua<CR>xxdpp<Esc>xi<Esc><CR>ap<Esc>xai<Esc>d<Esc>xdp<Esc>duiu<CR>da<Esc>uda<Esc><CR>ud<Esc><Esc>a<CR>xxp<Esc><CR><Esc><CR>u<Esc><CR>pdpa<Esc>uxpa<CR>ip<CR><Esc>dup<Esc><Esc><Esc>duppai<Esc>a<Esc>axpxxadadaud<Esc>i<Esc>dpi<CR>xa<Esc><CR>iddp<CR><Esc>axa<Esc>uipx<Esc>pxaixp")
end
do  -- round 22
safe(vim.api.nvim_list_bufs)
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-07-30/default/crashes/id:000006,sig:04,src:000000,time:2492283,execs:16473,op:havoc,rep:2 (837 bytes)
