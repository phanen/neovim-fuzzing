-- Auto-generated from /tmp/repro-from-crash/id:000017_sig:06_src:000000_time:425019_execs:1440_op:havoc_rep:15.log
...
--   out/nvim --headless --clean -i NONE -n -l /home/runner/work/neovim-fuzzing/neovim-fuzzing/reports/2026-07-19_115735/repros/id_000017_sig_06_src_000000_time_425019_execs_1440_op_havoc_rep_15/repro.lua
...
safe(vim.api.nvim_create_namespace, "fzcuvgail")
...
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzcwskuoi")
...
safe(vim.api.nvim_list_wins)
safe(vim.api.nvim_create_autocmd, "WinClosed", {["callback"]=_stub_cb_winclosed,["nested"]=true})
safe(vim.api.nvim_win_close, 1005, true)
safe(vim.api.nvim_win_close, 0, true)
safe(vim.api.nvim_create_buf, false, true)
...
safe(vim.cmd, "redrawstatus")
safe(vim.api.nvim_paste, "\0\2\3\6\21\22\23\24\27\127|}~CDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~", false, 3)
safe(vim.cmd, "redrawstatus")
safe(vim.cmd, 'redrawstatus')
end
do  -- round 11
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzcoqektg")
safe(vim.api.nvim_buf_set_extmark, 6, 5, 0, 0, {["sign_text"]="h"})
safe(vim.api.nvim_create_buf, false, true)
...
do  -- extra round 1 (round 11 replayed)
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzcoqektg")
safe(vim.api.nvim_buf_set_extmark, 6, 5, 0, 0, {["sign_text"]="h"})
...
do  -- extra round 2 (round 11 replayed)
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzcoqektg")
safe(vim.api.nvim_buf_set_extmark, 6, 5, 0, 0, {["sign_text"]="h"})
...
do  -- extra round 3 (round 11 replayed)
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzcoqektg")
safe(vim.api.nvim_buf_set_extmark, 6, 5, 0, 0, {["sign_text"]="h"})
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-07-19/default/crashes/id:000017,sig:06,src:000000,time:425019,execs:1440,op:havoc,rep:15 (1123 bytes)
