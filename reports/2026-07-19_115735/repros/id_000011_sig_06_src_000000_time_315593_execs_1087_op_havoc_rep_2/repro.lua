-- Auto-generated from /tmp/repro-from-crash/id:000011_sig:06_src:000000_time:315593_execs:1087_op:havoc_rep:2.log
...
--   out/nvim --headless --clean -i NONE -n -l /home/runner/work/neovim-fuzzing/neovim-fuzzing/reports/2026-07-19_115735/repros/id_000011_sig_06_src_000000_time_315593_execs_1087_op_havoc_rep_2/repro.lua
...
safe(vim.api.nvim_buf_set_name, 4, "/tmp/fzc_yixxsrmi.txt")
safe(vim.cmd, "redrawstatus")
safe(vim.cmd, 'redrawstatus')
end
do  -- round 6
...
do  -- round 7
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 7, true, {["noautocmd"]=false,["col"]=23,["zindex"]=135,["focusable"]=true,["relative"]="editor",["row"]=-3,["width"]=145,["height"]=13})
safe(vim.api.nvim_create_buf, false, true)
...
safe(vim.cmd, "redrawstatus")
safe(vim.api.nvim_paste, "\0\2\3\6\21\22\23\24\27\127{|}~VWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~abcdefghijklmnopqrstuvwxyz{|}~rstuvwxyz{|}~mnopqrstuvwxyz{|}~$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~yz{|}~", true, 0)
end
do  -- round 8
safe(vim.api.nvim_list_wins)
...
safe(vim.api.nvim_buf_set_extmark, 6, 3, 0, 0, {["sign_text"]="h"})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_win_set_buf, 0, 13)
safe(vim.api.nvim_buf_delete, 6, {["unload"]=true,["force"]=true})
safe(vim.api.nvim_buf_set_lines, 6, 0, -1, false, {[1]=""})
safe(vim.cmd, "redrawstatus")
end
do  -- round 10
safe(vim.cmd, "redrawstatus")
...
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzctadlku")
safe(vim.api.nvim_buf_set_extmark, 2, 4, 0, 0, {["sign_text"]="h"})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_win_set_buf, 0, 17)
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-07-19/default/crashes/id:000011,sig:06,src:000000,time:315593,execs:1087,op:havoc,rep:2 (1005 bytes)
