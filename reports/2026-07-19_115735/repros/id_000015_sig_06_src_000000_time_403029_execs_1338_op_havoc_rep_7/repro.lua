-- Auto-generated from /tmp/repro-from-crash/id:000015_sig:06_src:000000_time:403029_execs:1338_op:havoc_rep:7.log
...
--   out/nvim --headless --clean -i NONE -n -l /home/runner/work/neovim-fuzzing/neovim-fuzzing/reports/2026-07-19_115735/repros/id_000015_sig_06_src_000000_time_403029_execs_1338_op_havoc_rep_7/repro.lua
...
do  -- round 4
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 5, false, {["style"]="minimal",["relative"]="cursor",["width"]=63,["height"]=26,["row"]=43,["col"]=-12,["zindex"]=130,["hide"]=true,["noautocmd"]=false,["focusable"]=true})
safe(vim.api.nvim_list_tabpages)
safe(vim.cmd, "only")
safe(vim.cmd, "only")
safe(vim.cmd, "only")
...
safe(vim.cmd, "tabnew")
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 8, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
...
do  -- round 8
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 11, false, {["relative"]="win",["width"]=113,["height"]=2,["row"]=24,["col"]=-11,["zindex"]=6,["title"]="*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~3456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~cdefghijklmnopqrstuvwxyz{|}~opqrstuvwxyz{|}~3456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~TUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~",["title_pos"]="left",["noautocmd"]=false,["focusable"]=false})
safe(vim.api.nvim_list_tabpages)
safe(vim.cmd, "only")
safe(vim.cmd, "only")
safe(vim.cmd, "only")
...
do  -- round 10
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 20, false, {["relative"]="win",["width"]=143,["height"]=33,["row"]=-28,["col"]=-49,["zindex"]=108,["noautocmd"]=false,["external"]=true,["focusable"]=false})
...
do  -- round 11
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 21, true, {["style"]="minimal",["relative"]="cursor",["width"]=149,["height"]=9,["row"]=32,["col"]=-17,["zindex"]=837,["title"]="stuvwxyz{|}~BCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~BCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~tuvwxyz{|}~PQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~RSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~RSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~",["title_pos"]="right",["noautocmd"]=true,["focusable"]=false})
safe(vim.api.nvim_list_tabpages)
safe(vim.cmd, "only")
safe(vim.cmd, "only")
safe(vim.cmd, "only")
...
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 26, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
...
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 40, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
...
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 46, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 47, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.cmd, "redrawstatus")
safe(vim.cmd, "redrawstatus")
safe(vim.cmd, 'redrawstatus')
end
...
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 52, false, {["border"]="solid",["relative"]="cursor",["width"]=23,["height"]=24,["row"]=-15,["col"]=40,["zindex"]=85,["hide"]=true,["noautocmd"]=true,["focusable"]=false})
safe(vim.cmd, "tabnew")
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 53, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 54, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 55, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 56, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 57, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.cmd, "only")
safe(vim.api.nvim_buf_delete, 48, {["force"]=true})
safe(vim.api.nvim_buf_delete, 49, {["force"]=true})
safe(vim.api.nvim_buf_delete, 50, {["force"]=true})
safe(vim.api.nvim_buf_delete, 51, {["force"]=true})
safe(vim.cmd, "bdelete")
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 59, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 60, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 61, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 62, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 63, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.cmd, "redrawstatus")
end
do  -- round 17
safe(vim.api.nvim_list_wins)
safe(vim.api.nvim_create_autocmd, "WinClosed", {["nested"]=true,["callback"]=_stub_cb_winclosed})
safe(vim.api.nvim_win_close, 1047, true)
...
safe(vim.cmd, "tabnew")
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 64, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 65, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 66, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 67, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 68, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 69, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.cmd, "redrawstatus")
end
do  -- round 19
end
...
safe(vim.api.nvim_buf_set_extmark, 54, 19, 0, 0, {["sign_text"]="h"})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_win_set_buf, 0, 71)
safe(vim.api.nvim_buf_delete, 54, {["force"]=true,["unload"]=true})
safe(vim.api.nvim_win_close, 0, true)
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 72, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 73, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 74, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 75, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 76, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 77, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
end
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-07-19/default/crashes/id:000015,sig:06,src:000000,time:403029,execs:1338,op:havoc,rep:7 (1034 bytes)
