-- Auto-generated from /tmp/repro-from-crash/id:000022_sig:06_src:000000_time:635217_execs:1968_op:havoc_rep:8.log
...
--   out/nvim --headless --clean -i NONE -n -l /home/runner/work/neovim-fuzzing/neovim-fuzzing/reports/2026-07-19_115735/repros/id_000022_sig_06_src_000000_time_635217_execs_1968_op_havoc_rep_8/repro.lua
...
safe(vim.api.nvim_paste, "\0\2\3\6\21\22\23\24\27\127123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~)*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~UVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~YZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~9:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~56789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~", false, 3)
end
do  -- round 4
safe(vim.cmd, "redraw")
safe(vim.api.nvim_paste, "\0\2\3\6\21\22\23\24\27\127;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~uvwxyz{|}~YZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~pqrstuvwxyz{|}~-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~lmnopqrstuvwxyz{|}~ijklmnopqrstuvwxyz{|}~", true, 0)
end
do  -- round 5
safe(vim.api.nvim_list_wins)
...
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_paste, "\0\2\3\6\21\22\23\24\27\1270123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~abcdefghijklmnopqrstuvwxyz{|}~*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~|}~nopqrstuvwxyz{|}~=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~", true, 2)
end
do  -- round 8
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 2, true, {["border"]="shadow",["relative"]="cursor",["width"]=119,["height"]=50,["row"]=-13,["col"]=0,["zindex"]=154,["noautocmd"]=true,["title"]="<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~3456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~QRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~",["title_pos"]="left",["focusable"]=true})
...
do  -- round 10
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 5, false, {["zindex"]=181,["noautocmd"]=true,["relative"]="win",["focusable"]=true,["width"]=156,["height"]=22,["row"]=-49,["col"]=-2})
safe(vim.api.nvim_list_tabpages)
safe(vim.cmd, "only")
safe(vim.cmd, "only")
safe(vim.cmd, "only")
...
do  -- round 12
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 6, false, {["style"]="minimal",["relative"]="cursor",["external"]=true,["width"]=32,["height"]=47,["row"]=-38,["col"]=25,["zindex"]=65,["noautocmd"]=false,["focusable"]=false})
...
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 18, false, {["border"]="solid",["relative"]="cursor",["width"]=23,["height"]=24,["row"]=-15,["hide"]=true,["zindex"]=85,["noautocmd"]=true,["col"]=40,["focusable"]=false})
safe(vim.cmd, "tabnew")
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 19, false, {["relative"]="editor",["width"]=10,["height"]=5,["row"]=0,["col"]=0})
safe(vim.api.nvim_create_buf, false, true)
...
safe(vim.api.nvim_buf_set_extmark, 24, 3, 0, 0, {["sign_text"]="h"})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_win_set_buf, 0, 28)
safe(vim.api.nvim_buf_delete, 24, {["force"]=true,["unload"]=true})
safe(vim.api.nvim_win_close, 0, true)
safe(vim.api.nvim_create_buf, false, true)
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-07-19/default/crashes/id:000022,sig:06,src:000000,time:635217,execs:1968,op:havoc,rep:8 (1026 bytes)
