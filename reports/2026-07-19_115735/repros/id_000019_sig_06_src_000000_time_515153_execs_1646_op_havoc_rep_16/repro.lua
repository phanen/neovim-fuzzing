-- Auto-generated from /tmp/repro-from-crash/id:000019_sig:06_src:000000_time:515153_execs:1646_op:havoc_rep:16.log
...
--   out/nvim --headless --clean -i NONE -n -l /home/runner/work/neovim-fuzzing/neovim-fuzzing/reports/2026-07-19_115735/repros/id_000019_sig_06_src_000000_time_515153_execs_1646_op_havoc_rep_16/repro.lua
...
safe(vim.api.nvim_paste, "\0\2\3\6\21\22\23\24\27\127abcdefghijklmnopqrstuvwxyz{|}~=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~)*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~BCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~klmnopqrstuvwxyz{|}~", false, 3)
end
do  -- round 4
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 2, false, {["hide"]=true,["style"]="minimal",["relative"]="editor",["noautocmd"]=false,["width"]=37,["height"]=10,["row"]=2,["col"]=12,["zindex"]=100,["focusable"]=true,["bufpos"]={[1]=0,[2]=14,[3]=44},["anchor"]="SE"})
...
safe(vim.api.nvim_paste, "\0\2\3\6\21\22\23\24\27\127", true, 2)
end
do  -- round 5
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 4, true, {["title"]="<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~3456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~QRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~",["title_pos"]="right",["border"]="shadow",["relative"]="cursor",["noautocmd"]=true,["width"]=119,["height"]=50,["row"]=-13,["col"]=0,["zindex"]=154,["focusable"]=true})
safe(vim.api.nvim_list_tabpages)
safe(vim.cmd, "tabnew")
safe(vim.cmd, "only")
safe(vim.cmd, "only")
...
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzcqxmfsl")
safe(vim.api.nvim_buf_set_extmark, 4, 3, 0, 0, {["sign_text"]="h"})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_win_set_buf, 0, 6)
safe(vim.api.nvim_buf_delete, 4, {["force"]=true,["unload"]=true})
...
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzcxwpqfl")
safe(vim.api.nvim_buf_set_extmark, 5, 4, 0, 0, {["sign_text"]="h"})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_win_set_buf, 0, 7)
safe(vim.api.nvim_buf_delete, 5, {["force"]=true,["unload"]=true})
safe(vim.api.nvim_buf_set_lines, 5, 0, -1, false, {[1]=""})
safe(vim.cmd, "redrawstatus")
safe(vim.cmd, "redrawstatus")
safe(vim.cmd, 'redrawstatus')
end
...
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 14, false, {["focusable"]=false,["style"]="minimal",["border"]="shadow",["relative"]="cursor",["noautocmd"]=false,["width"]=164,["height"]=30,["row"]=17,["col"]=34,["zindex"]=106,["bufpos"]={[1]=10,[2]=28,[3]=20}})
...
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 19, false, {["width"]=10,["height"]=5,["row"]=0,["col"]=0,["relative"]="editor"})
safe(vim.cmd, "only")
safe(vim.api.nvim_list_wins)
safe(vim.api.nvim_win_close)
safe(vim.api.nvim_list_tabpages)
...
safe(vim.api.nvim_win_close, 1013, true)
safe(vim.cmd, "redrawstatus")
end
do  -- round 18
safe(vim.api.nvim_create_autocmd, "WinLeave", {["callback"]=_stub_cb_winleave})
...
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzccfjodt")
safe(vim.api.nvim_buf_set_extmark, 23, 5, 0, 0, {["sign_text"]="h"})
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_win_set_buf, 0, 26)
safe(vim.api.nvim_buf_delete, 23, {["force"]=true,["unload"]=true})
...
do  -- extra round 1 (round 19 replayed)
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzccfjodt")
safe(vim.api.nvim_buf_set_extmark, 23, 5, 0, 0, {["sign_text"]="h"})
...
do  -- extra round 2 (round 19 replayed)
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzccfjodt")
safe(vim.api.nvim_buf_set_extmark, 23, 5, 0, 0, {["sign_text"]="h"})
...
do  -- extra round 3 (round 19 replayed)
safe(vim.api.nvim_set_option_value, "signcolumn", "auto:3", {})
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_namespace, "fzccfjodt")
safe(vim.api.nvim_buf_set_extmark, 23, 5, 0, 0, {["sign_text"]="h"})
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-07-19/default/crashes/id:000019,sig:06,src:000000,time:515153,execs:1646,op:havoc,rep:16 (1051 bytes)
