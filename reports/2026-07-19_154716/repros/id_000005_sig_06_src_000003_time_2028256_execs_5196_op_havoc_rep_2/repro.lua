-- Auto-generated from /tmp/repro-from-crash/id:000005_sig:06_src:000003_time:2028256_execs:5196_op:havoc_rep:2.log
...
--   out/nvim --headless --clean -i NONE -n -l /home/runner/work/neovim-fuzzing/neovim-fuzzing/reports/2026-07-19_154716/repros/id_000005_sig_06_src_000003_time_2028256_execs_5196_op_havoc_rep_2/repro.lua
...
safe(vim.api.nvim_open_win, 2, false, {["focusable"]=true,["border"]="rounded",["relative"]="editor",["width"]=179,["noautocmd"]=false,["row"]=29,["col"]=-13,["zindex"]=61,["bufpos"]={[1]=0,[2]=17,[3]=41},["height"]=43})
...
do  -- round 3
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 4, false, {["focusable"]=true,["relative"]="editor",["width"]=118,["noautocmd"]=false,["row"]=7,["col"]=-14,["zindex"]=137,["anchor"]="NW",["height"]=12})
safe(vim.api.nvim_list_tabpages)
safe(vim.cmd, "tabnew")
safe(vim.cmd, "only")
safe(vim.cmd, "only")
...
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_create_buf, false, true)
safe(vim.api.nvim_open_win, 6, false, {["focusable"]=false,["border"]="double",["relative"]="win",["width"]=70,["noautocmd"]=false,["row"]=7,["title_pos"]="left",["zindex"]=117,["col"]=-32,["bufpos"]={[1]=4,[2]=21,[3]=29},["title"]="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~yz{|}~<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~9:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~EFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~",["height"]=39})
...
do  -- round 6
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_buf_set_option, 5, "undolevels", -1)
safe(vim.api.nvim_create_namespace, "fzcxuvogf")
safe(vim.api.nvim_buf_set_lines, 5, 0, -1, false, {[1]="a",[2]="b",[3]="c"})
safe(vim.api.nvim_buf_set_extmark, 5, 3, 0, 0, {["invalidate"]=true})
safe(vim.cmd, "undo")
safe(vim.cmd, "redo")
safe(vim.cmd, "undo")
safe(vim.cmd, "redrawstatus")
...
do  -- round 12
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_buf_set_option, 11, "undolevels", -1)
safe(vim.api.nvim_create_namespace, "fzcklfrpi")
safe(vim.api.nvim_buf_set_lines, 11, 0, -1, false, {[1]="a",[2]="b",[3]="c"})
safe(vim.api.nvim_buf_set_extmark, 11, 4, 0, 0, {["invalidate"]=true})
safe(vim.cmd, "undo")
safe(vim.cmd, "redo")
safe(vim.cmd, "undo")
safe(vim.cmd, "redrawstatus")
...
safe(vim.api.nvim_list_wins)
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_win_set_buf, 1009, 7)
end
do  -- round 14
safe(vim.api.nvim_list_bufs)
safe(vim.api.nvim_list_bufs)
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-07-19/default/crashes/id:000005,sig:06,src:000003,time:2028256,execs:5196,op:havoc,rep:2 (1042 bytes)
