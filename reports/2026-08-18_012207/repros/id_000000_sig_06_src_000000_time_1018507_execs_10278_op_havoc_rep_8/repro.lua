...
safe(vim.api.nvim_input, "dui<Esc>axupx<Esc><Esc>a<CR>dpi<Esc>auiia<Esc>i<CR>idiia<Esc><CR>dpip<CR>uddiuduuipu<Esc>dip<Esc><Esc>ipiax<CR>xpdidauppii<CR>x<Esc>u<Esc>u<CR>dxdxu<Esc>x<Esc>xxup<Esc>xpd<Esc>a<Esc>d<Esc>d<Esc>dudipaa<CR><Esc>pixxua<Esc>padda<CR><Esc>ddpipa<CR><Esc>daiudaiuu<CR><CR><CR>udu<Esc><CR><CR>pux<CR><Esc>ixxdpppuaud<Esc>aia<CR><Esc>dapd<CR><Esc><CR>pd<CR>aaaadui<CR>udx<CR><CR>iiapux<CR>piuix<CR>iapxaapxuuax<Esc><Esc>d<CR>xdudxaaiu<Esc>pix<CR>aixd<Esc><CR>a<CR>xp<Esc>uxip<Esc><Esc><Esc>dui<Esc>axupx<Esc><Esc>a<CR>dpi<Esc>auiia<Esc>i<CR>idiia<Esc><CR>dpip<CR>uddiuduuipu<Esc>dip<Esc><Esc>ipiax<CR>xpdidauppii<CR>x<Esc>u<Esc>u<CR>dxdxu<Esc>x<Esc>xxup<Esc>xpd<Esc>a<Esc>d<Esc>d<Esc>dudipaa<CR><Esc>pixxua<Esc>padda<CR><Esc>ddpipa<CR><Esc>daiudaiuu<CR><CR><CR>udu<Esc><CR><CR>pux<CR><Esc>ixxdpppuaud<Esc>aia<CR><Esc>dapd<CR><Esc><CR>pd<CR>aaaadui<CR>udx<CR><CR>iiapux<CR>piuix<CR>iapxaapxuuax<Esc><Esc>d<CR>xdudxaaiu<Esc>pix<CR>aixd<Esc><CR>a<CR>xp<Esc>uxip<Esc><Esc><Esc>dui<Esc>axupx<Esc><Esc>a<CR>dpi<Esc>auiia<Esc>i<CR>idiia<Esc><CR>dpip<CR>uddiuduuipu<Esc>dip<Esc><Esc>ipiax<CR>xpdi")
end
do  -- round 2
...
do  -- round 5
safe(vim.api.nvim_echo, {[1]={[1]="`abcdefghijklmnopqrstuvwxyz{|}~"}}, true, {["kind"]="completion"})
...
safe(vim.cmd, "redrawstatus")
safe(vim.api.nvim_paste, "\0\2\3\6\21\22\23\24\27\127STUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~YZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~", true, -1)
end
do  -- round 10
safe(vim.cmd, "vsplit")
...
os.exit(0)
-- 
-- Source crash: afl-findings/daily-2026-08-18/default/crashes/id:000000,sig:06,src:000000,time:1018507,execs:10278,op:havoc,rep:8 (1024 bytes)
